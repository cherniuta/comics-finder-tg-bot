...
import (
	...
	index_initiator "yadro.com/course/search/adapters/index-initiator"
...
func run(cfg config.Config, log *slog.Logger) error {
	...
	initiator := index_initiator.NewTickerInitiator(searcher, cfg.IndexTTL)
